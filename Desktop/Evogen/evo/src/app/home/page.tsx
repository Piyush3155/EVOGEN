          ...
          >
            ...
            <div className="relative h-full flex flex-col items-center justify-center">
              <motion.div
                ...
                style={{ fontFamily: "var(--font-requiem)" }}
              >
                <h2 className="text-4xl md:text-8xl font-extrabold drop-shadow-[0_0_15px_rgba(0,229,255,0.5)] bg-clip-text text-transparent"
  style={{
    ...
    fontFamily: "var(--font-requiem)"
              ...
              <nav className="flex flex-col items-center space-y-8">
                {["Home", "Events", "Register", "Contact", "Organizers", "Developers"].map((item, index) => (
                  <motion.a
                    key={item}
                    href={item === "Organizers" ? "#" : item === "Developers" ? "#" : `#${item.toLowerCase()}`}
                    onClick={
                      item === "Organizers" ? openOrganizers : item === "Developers" ? openDevelopers : toggleMenu
                    }
      ...
      <header className="w-full bg-black/40 backdrop-blur-sm text-white z-10 py-2 sticky top-0 border-b border-cyan-500/30">
        ...
        >
          ...
          <div className="text-center flex-grow">
            <p className="text-xs md:text-lg font-medium text-cyan-300">The Karnataka Law Society's</p>
      ...
      <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-0 w-full text-center opacity-0">
          <h1 className="text-[60px] md:text-[180px] font-extrabold drop-shadow-[0_0_15px_rgba(255,215,0,0.5)] bg-clip-text text-transparent" 
           style={{
            backgroundImage: "url('/textbg.jpg')",
            backgroundSize: "cover",
            backgroundPosition: "center",
...
<br/>
<p className="text-xl font-extrabold drop-shadow-[0_0_15px_rgba(255,215,0,0.5)] bg-clip-text text-transparent"
 style={{
  backgroundImage: "url('/textbg.jpg')",
  backgroundSize: "cover",
  backgroundPosition: "center",
        ...
        <div className="w-full px-6 md:px-14 py-16 md:py-24 bg-black/50 backdrop-blur-sm mt-20 md:mt-10 rounded-xl border border-cyan-500/20">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="w-full md:w-1/2">
              <p
                className="text-base text-l md:text-2xl text-cyan-100 max-w-2xl mx-auto text-justify "
                style={{ fontFamily: "var(--font-requiem)" }}
              >
                Evogen is a dynamic platform that empowers students to unleash their creativity and technical skills. From coding and web development to designing and UI/UX, it provides exciting opportunities to build innovative websites, applications, and user-centric experiences. In the field of cybersecurity, participants safeguard digital systems and tackle real-world problems. The quiz challenges test not only technical expertise but also quick thinking under pressure. Through communication and digital marketing events, students craft compelling content and drive ideas with creativity. Data analytics and machine learning tracks enable them to turn data into smart, actionable insights. Evogen fosters innovation, collaboration, and personal growth — where passion turns into potential, and skills meet real opportunities.</p>
            </div>
          </div>
